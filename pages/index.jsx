            ...
            <div className="section hero-started">
              ...
              >
                ...
                <div className="description">
                  <div>
                    <p>
                    Hello! I'm a Frontend Developer based in Indore, India, with 2 years of experience. I have a strong background in web design and I'm proficient in various technologies including HTML, CSS, JavaScript, React.js, Node.js, WordPress, Shopify, Teachable, Figma and Photoshop. I would love to discuss our unique projects and collaborate with you.
                    </p>
                  </div>
                  <div className="social-links">
                    <a target="_blank" rel="nofollow" href="https://wa.me/9926028543?text=Hello%20Abbas">
                      <i aria-hidden="true" className="fab fa-whatsapp" />
                    </a>
                    <a target="_blank" rel="nofollow" href="https://www.linkedin.com/in/abbas-badshah-846787230/">
                ...
                <div className="skills-items">
                  ...
                  >
                    ...
                    <div className="text">
                      <div>
                        <p>
                        While I don't engage in extensive PHP coding, I am capable of making small changes and modifications to PHP code as needed.
                        </p>
                      </div>
                    </div>
                    <div className="dots">
                  ...
                  >
                    ...
                    <div className="text">
                      <div>
                        <p>
                        My knowledge of Node.js enables me to develop server-side applications efficiently.
                        </p>
                      </div>
                    </div>
                    <div className="dots">
                ...
                <div className="skills-items">
                  ...
                  >
                    ...
                    <div className="text">
                      <div>
                        <p>
                        I am skilled in JavaScript and can leverage its capabilities to add interactivity and functionality to web applications.
                        </p>
                      </div>
                    </div>
                    <div className="dots">
                ...
                <div className="skills-items">
                  ...
                  >
                    ...
                    <div className="text">
                      <div>
                        <p>
                        Experienced in WordPress for 2 years, proficient in website designing, plugin development, and diverse WordPress tasks.
                        </p>
                      </div>
                    </div>
                    <div className="dots">
